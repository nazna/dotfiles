...
ln -nfs $HOME/workspace/ghq/github.com/naoya3e/dotfiles/hyper.zshrc $HOME/.hyper.zshrc
...
ln -nfs $HOME/workspace/ghq/github.com/naoya3e/dotfiles/starship.toml $HOME/.config/starship.toml
